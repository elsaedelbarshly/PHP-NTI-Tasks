...
$fmax = $_POST['fnum'] > $_POST['snum'] ? $_POST['fnum'] : $_POST['snum'];
$max = $_POST['tnum'] > $fmax ? $_POST['tnum'] : $fmax;

$message = "The Greater Number is : $max ";
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 mt-5">
        <h1 class="text-dark text-center h1"> Max </h1>
      </div>
      <div class="offset-4 col-4">
        <form method="post">
          ...
          <div class="form-group">
            <label for="name">Third Number</label>
            <input type="text" name="Tnum" id="Tnum" class="form-control" placeholder="" aria-describedby="helpId">
          </div>
