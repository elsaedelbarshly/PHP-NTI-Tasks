  ...
  <div class="container">
    <div class="row">
      <div class="col-12 mt-5">
        <h1 class="text-dark text-center h1"> Hospital </h1>
      </div>
      <div class="offset-4 col-4">
        <form method="post">
          <div class="form-group">
            ...
            <?php 
              if(!empty($errors['number-required'])){
                echo $errors['number-required'];
              }
          ?>
          <div class="form-group offset-4 col-3 mt-5">
            <button name="neg-pos" class="btn btn-dark rounded">Send</button>
          </div>
        </form>
      </div>
    </div>
